...
def read_game_config(game_name, iterations=1000) -> GameConfig:
    game_configs = [
        ...
        GoofSpielImp(iterations),
        GoofSpiel(iterations),  #num_cards=cards
        LiarsDice(iterations),   # dice_sides=sides, num_dice=1
        BattleShip(iterations),   # board_width=3, board_height=2, num_shots=3
    ]

    game_dict = {game_config.game_name: game_config for game_config in game_configs}
    print(game_dict)
